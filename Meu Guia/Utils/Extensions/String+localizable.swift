...
extension String {
  static var alert: String { "alert".localized }
  ...
  static var placesMapTitle: String { "placesMapTitle".localized }

  static var searchPlaceText: String { "searchPlaceText".localized }
  static var seeDetailsText: String { "seeDetailsText".localized }
  ...
  static var homeHelpTitle: String { "homeHelpTitle".localized }
  static var tourListingHelpMessage: String { "tourListingHelpMessage".localized }
  static var tourListingHelpTitle: String { "tourListingHelpTitle".localized }
  static var tourDetailHelpMessage: String { "tourDetailHelpMessage".localized }
  static var tourDetailHelpTitle: String { "tourDetailHelpTitle".localized }
